...
import com.reactlibrary.utils.MyConnectionBuilder;
...
public class RNAppAuthModule extends ReactContextBaseJavaModule implements ActivityEventListener {
            ...
            AuthorizationServiceConfiguration.fetchFromUrl(
                    ...
                    new AuthorizationServiceConfiguration.RetrieveConfigurationCallback() {
                        public void onFetchConfigurationCompleted(
                            ...
                            if (ex != null) {
                                promise.reject("RNAppAuth Error", "Failed to fetch configuration "+ex.toJsonString(), ex);
                                return;
                            }
    ...
    private ConnectionBuilder createConnectionBuilder(Boolean allowInsecureConnections) {
        ...
        return MyConnectionBuilder.INSTANCE;
    }
